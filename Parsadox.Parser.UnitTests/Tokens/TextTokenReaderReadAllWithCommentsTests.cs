...
public class TextTokenReaderReadAllWithCommentsTests : TextTokenReaderTestsBase
{
    ...
    [TestCase("\"eof in string\\", "\"eof in string\\\\\"")]
    [TestCase("#comment\nkey1=value", "#comment key1 = value")]
    [TestCase("key1#comment\n=value", "key1 #comment = value")]
    [TestCase("key1=#comment\nvalue", "key1 = #comment value")]
    [TestCase("key1=value#comment", "key1 = value #comment")]
    ...
    [TestCase("\"key2\"={value}", "\"key2\" = { value }")]
    [TestCase("{}key1{}", "{ } key1 { }")]
    public void ReadAllWithComments_Valid_IsCorrect(string source, string expectedResult)
    {
    ...
    [Test]
    public void ReadAllWithComments_ComplexFile_IsCorrect()
    {
        string result = ReadAll(TestData.SaveGame, '\n');

        Assert.That(result, Is.EqualTo(TestData.SaveGame_TokensWithComments.NoCr()));
    }
}
